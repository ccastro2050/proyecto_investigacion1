...
```bash
curl http://localhost:8070/api/area_conocimiento        # total: 8
curl -i http://localhost:8070/api/area_conocimiento/PR999   # → 404
```
...
- [ ] Modelos/AreaConocimiento.cs (la entidad: 4 propiedades tipadas)
- [ ] Peticiones/AreaConocimientoCrear.cs (todo obligatorio, con [Required])
