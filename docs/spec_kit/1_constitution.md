...
esta v1 toma **una** tabla, no seis.
...
2. Su servicio en el compose **no depende del motor** de base de datos.
...
fuera** —con SSMS o SQLTools contra `localhost:11470`— y entonces se lee
